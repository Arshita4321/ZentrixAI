...
export const AskZentrixAIChat = ({ reportId, companyName }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setHistory((prev) => [
        ...prev,
        { role: 'assistant', content: 'Connection error communicating with Zentrix AI server.' }
      ]);
    } finally {
      setLoading(false);
    }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-extrabold text-white text-lg flex items-center gap-2">
              Ask Zentrix AI Institutional AI
