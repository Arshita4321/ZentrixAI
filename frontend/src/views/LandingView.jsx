      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800 bg-slate-900/50 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Research two companies side-by-side. Zentrix AI evaluates relative valuation, moat durability, and risks to issue a capital allocation winner.
            </p>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800 bg-slate-900/50 space-y-3">
            ...
            <h4 className="font-bold text-white text-sm">Ask Zentrix AI Chat</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <footer className="border-t border-slate-800 py-12 bg-slate-950 text-xs text-slate-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-white text-base">Zentrix AI</span>
          ...
          <div className="border-t border-slate-800/80 pt-6 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-[11px] text-slate-500 leading-relaxed max-w-2xl">
              Zentrix AI is an AI-powered institutional research and decision-support tool. It is for informational and analysis purposes only and does not constitute financial, investment, or legal advice.
            </p>
            <p className="text-[11px] font-mono text-slate-500">
              &copy; {new Date().getFullYear()} Zentrix AI. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
