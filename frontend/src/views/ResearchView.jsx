...
import { AskZentrixAI } from '../components/AskZentrixAI';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      {report && (
        <div className="space-y-8 animate-in fade-in duration-500">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-xl sm:text-2xl font-extrabold text-white mt-1">
                    Zentrix AI recommends {report.verdict} on {report.companyName || report.resolvedCompanyName} with {report.confidence}% confidence.
                  </h2>
                </div>
              </div>
                ...
                <button
                  onClick={() => {
                    setChatTriggerPrompt(
                      `Why did Zentrix AI rate ${report.companyName || report.resolvedTicker} a ${report.verdict} (${report.confidence}% confidence) instead of a stronger alternative? Explain the exact trade-offs.`
                    );
                    setTimeout(() => {
                      document.getElementById('ask-zentrix-section')?.scrollIntoView({ behavior: 'smooth' });
                    }, 100);
                  }}
                  ...
                  title="Ask Zentrix AI why this verdict was selected"
                >
          ...
          {/* Ask Zentrix AI Grounded Multi-Turn Conversational Assistant Panel */}
          <div id="ask-zentrix-section">
            <AskZentrixAI
