...
if (missingVars.length > 0) {
  ...
  console.error('Please configure your .env file before starting the ZentrixAI API.');
  process.exit(1);
}
...
console.log('==================================================');
console.log('            ZENTRIXAI API STARTUP CHECK            ');
console.log('==================================================');
...
const MONGO_URI =
  process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://localhost:27017/zentrixai';
...
app.listen(PORT, () => {
  console.log(`🚀 ZentrixAI Backend running on http://localhost:${PORT}`);
});
